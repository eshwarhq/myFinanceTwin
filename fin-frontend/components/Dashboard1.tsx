...
export function Dashboard1({ isFirstTime = false, onOnboardingComplete }: DashboardProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-10">
      ...
      <main className="container mx-auto px-6 py-24 pt-1">
        ...
        {/* Header */}
        <footer className="fixed bottom-4 right-4 -translate-x-1/2 z-50 bg-white/40 backdrop-blur-md border border-border shadow-xl rounded-full px-5 py-5 flex items-center">
